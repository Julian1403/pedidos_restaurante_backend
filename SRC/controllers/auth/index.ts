...
try {
    ...
    //esto devuelve mi backend en el momento q me autentique:
    return res.status(200).json({token,email:findUser.email,name:findUser.name});//se agrega lo de email y name para el fronted.
